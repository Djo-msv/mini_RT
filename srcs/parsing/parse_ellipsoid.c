...
/*   Updated: 2025/07/16 19:59:44 by star             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_ellipsoid(t_scene *scene, char **args)
{
	...
	t_matrix ro = mul_mat4(mul_mat4(mat4_rotation_z(ellipsoid->normal.z), mat4_rotation_y(ellipsoid->normal.y)), mat4_rotation_x(ellipsoid->normal.x));
